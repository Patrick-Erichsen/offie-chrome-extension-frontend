...
/*!*********************************!*\
  ...
  \*********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _content_analytics__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../content/analytics */ "./src/content/analytics.ts");

chrome.tabs.onUpdated.addListener(function (tabId, _a) {
    var url = _a.url;
    if (url) {
        var newUrl = { event: 'URL_UPDATE', url: url };
